...
# this is a original refference to the 
# code for the CodeCheck 2.0 research project.
# the code/comments in this build may not 
# be up to date. This is for historic/research 
# refference.
...
def codeCheck2(inputA,inputB):
    ...
    print("filteredAStream: ",filteredAStream)
    print("filteredBStream: ",filteredBStream)
    
#######################################################

codeCheck2("The quick brown fox jumps over the lazy dog.",
            "The fast brown fox leaps over the idle canine.")

#codeCheckLegacy("The quick brown fox jumps over the lazy dog.",
#            "The fast brown fox leaps over the idle canine.")
